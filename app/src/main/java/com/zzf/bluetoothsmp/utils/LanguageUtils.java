...
public class LanguageUtils {
    ...
    public static void updateLanguage(final Context context, Locale locale) {
        ...
        Log.e(TAG, "当前语言: "+contextLocale.getLanguage());
    ...
    public static void applyAppLanguage(@NonNull Activity activity) {
        ...
        updateLanguage(MyApplication.getAppContext(), appLocale);
    ...
    private static String getPrefAppLocaleLanguage() {
        SharedPreferences sp = MyApplication.getAppContext().getSharedPreferences(AppConstants.I18N, Context.MODE_PRIVATE);
